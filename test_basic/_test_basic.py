...
def run(iterations, results_name, activemq_script):
	...
	for i in iterations:
		print("Running: " + str(i))
		print("Starting Read")
		runner_receiver = _common.run_command_back("python2 ./message_queue_py/read.py " + str(i))
		print("Starting Send")
		runner_sender = _common.run_command_back("python2 ./message_queue_py/send.py " + str(i))
